...
adaptation_lib.add_item("ingot_copper", {
    name = "mcl_core:copper_ingot",
  })
adaptation_lib.add_item("ingot_tin", {
    name = "mcl_core:tin_ingot",
  })
adaptation_lib.add_item("ingot_bronze", {
    name = "mcl_core:bronze_ingot",
  })
...
adaptation_lib.add_item("wood_pine", {
    name = "mcl_core:pine_wood",
    tile = "mcl_core_pine_wood.png",
    sounds = mcl_sounds.node_sound_wood_defaults(),
    lists = {"wood"},
  })
...
adaptation_lib.add_item("tree_spruce", {
    name = "mcl_core:spruce_tree",
    tile = "mcl_core_spruce_tree.png",
    sounds = mcl_sounds.node_sound_wood_defaults(),
    lists = {"tree"},
  })
